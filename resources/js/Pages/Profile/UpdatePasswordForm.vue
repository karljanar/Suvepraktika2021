<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Veenduge, et teie konto kasutab turvalisuse tagamiseks pikka juhuslikku parooli.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Praegune Parool" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Uus Parool" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password_confirmation" value="Kinnita Parool" />
